...
public sealed class PurchasePriorityModel(ICardService cardService, IPendingOrderRepository pendingOrderRepository) : SearchablePageModel
{
    ...
    public override IReadOnlyDictionary<string, string?> GetPaginationParams() =>
        ...
        {
            ["totalBudget"] = TotalBudget?.ToString(System.Globalization.CultureInfo.InvariantCulture),
            ["maxCards"] = MaxCards?.ToString(System.Globalization.CultureInfo.InvariantCulture),
            ["maxPricePerCard"] = MaxPricePerCard?.ToString(System.Globalization.CultureInfo.InvariantCulture)
        };
